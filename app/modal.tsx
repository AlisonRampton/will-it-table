...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <button
        className="bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
      ...
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-3/4 my-6 mx-8 max-w-4xl min-w-[400px]">
              {/*content*/}
